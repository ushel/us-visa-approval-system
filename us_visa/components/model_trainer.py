...
from sklearn.metrics import accuracy_score,f1_score,precision_score, recall_score, recall
...
class ModelTrainer:
    ...
    def get_model_object_and_report(self, train: np.array, test: np.array) -> Tuple[object, object]:
        ...
        Description: This function uses neuro_mf to get the best model and report of the best model
        
        Output: Returns metric artifact object nad best model object
