...
from us_visa.entity.artifact_entity import ModelTrainerArtifact,DataInjectionArtifact,ModelEvaluatorArtifact
...
class ModelEvaluation:
    def __init__(self, model_eval_config: ModelEvaluationConfig, data_ingestion_artifact: DataInjectionArtifact,
                model_trainer_artifact: ModelTrainerArtifact):
        try:
            self.model_eval_config = model_eval_config
            self.data_injestion_artifact = data_ingestion_artifact
