...
class SimpleStorageService:
    ...
    def read_object(object_name: str, decode: bool = True, make_readable: bool = False) -> Union[StringIO,]:
        ...
        try:
            ...
            logging.info("Exited the read_object method od S3Operations class")
            return conv_func()
        except Exception as e:
            raise USVisaException(e, sys) from e
    ...
    def get_bucket(self, bucket_name: str) -> Bucket:
        ...
        Revisions: moved setup to cloud
        """
        logging.info("Entered the get_bucket method od S3Operations class")
    ...
    def upload_file(self, from_filename:str, to_filename:str, bucket_name:str, remove:bool = True):
        ...
        Description: This method uploads from_filename file to bucket_name with to_filename as name.
        
        Output: Folder created in s3 bucket
        On Failure: Write an exception log and then raise an exception
